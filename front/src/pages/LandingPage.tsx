    ...
    <div>
      ...
      <div className="bg-gray-100 lg:h-[95vh] sm:h-min-screen flex flex-col justify-center items-center pt-20">
        <header className="text-center mb-16 px-4 sm:px-8 w-full pt-5">
          ...
          <img
            src={pizza} 
            className="w-full max-w-48 h-auto mx-auto mt-6" 
            alt="pizza image" 
          />
        </header>
        ...
        <main className="bg-white shadow-md rounded-lg w-full max-w-3xl p-8 mx-4 sm:mx-0">
          ...
          <ol className="list-decimal list-inside text-gray-600 mb-8">
            <li>
              Preencha os dados básicos do seu projeto, como o nome dele e tipo
              de comércio.
            </li>
            <li>
              Informe sua região para receber custos relacionados ao preço
              local.
            </li>
            <li>
          ...
          <div className="text-center py-5">
            <Link
              to="/signin"
              className="bg-lightPink text-white font-bold py-3 px-6 rounded-lg hover:bg-lightRed transition"
            >
              Comece agora!
            </Link>
          </div>
      ...
      <footer className="text-center py-3 text-gray-500 flex justify-center items-center">
        <p>
          &copy; 2024 Seu Orçamento Gastronômico. Todos os direitos reservados.
        </p>
      </footer>
    </div>
  );
